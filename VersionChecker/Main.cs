...
namespace Straitjacket.Utility.VersionChecker
{
    ...
    public class Main
    {
        ...
        private static void InitializeVersionCheckerVersionChecks()
        {
            ...
            VersionChecker.Main.Check(QModGame.Subnautica, 467, QModServices.Main.GetMyMod(), url);
#elif BELOWZERO
            var url = "https://github.com/tobeyStraitjacket/VersionChecker/raw/master/VersionChecker/mod_BELOWZERO.json";
            VersionChecker.Main.Check(QModGame.BelowZero, 66, QModServices.Main.GetMyMod(), url);
#endif
        }
        ...
        {
#if SUBNAUTICA
            VersionChecker.Main.Check(QModGame.Subnautica, 201, new QModManagerQMod());
#elif BELOWZERO
            VersionChecker.Main.Check(QModGame.BelowZero, 1, new QModManagerQMod());
#endif
        }
                    ...
                    try
                    {
                        ...
                        if (modJson.NexusId != null && (modJson.NexusId.Subnautica != null || modJson.NexusId.BelowZero != null))
                        {
                            ...
                            try
                            {
                                ...
                                VersionChecker.Main.Check(game, modId, qMod, modJson.VersionChecker?.LatestVersionURL);
                                break;
                            }
                        ...
                        {
                            VersionChecker.Main.Check(modJson.VersionChecker.LatestVersionURL, qMod);
                        }
                    }
                    catch (Exception e)
                    {
